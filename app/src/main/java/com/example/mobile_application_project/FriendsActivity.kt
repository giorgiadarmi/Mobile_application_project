    ...
    private fun fetchCurrentUser() {
        ...
        userRef.addListenerForSingleValueEvent(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@FriendsActivity, "Failed to load user data", Toast.LENGTH_SHORT).show()
            }
        })
    }
    ...
    private fun fetchUsers() {
        ...
        database.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                val adapter = UserAdapter(this@FriendsActivity, R.layout.user_item, userList)
                userListView.adapter = adapter
            }

            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@FriendsActivity, "Failed to load users", Toast.LENGTH_SHORT).show()
            }
        })
    }
